      ...
      <div className={(this.props.seen) ? "about-container" : "about-container-close"}>
        ...
        <div className="about">
          ...
          <div className="about-section">
            ...
            <p>Click the settings icon on upper left corner to access game controls.</p>
            <p>Use the Cell Size slider to adjust the size of the board</p>
            <p>On mobile devices use the Cell Size slider to zoom in to setup a configuration</p>
                  
            <p>Use "Refresh Frequency" slider to control playback speed</p>
            <p>
              Use Population Density slider to set cell density generated by
              Seed
            </p>
                  <p>Press "Redraw Board" to use current Cell Size to draw a board(same as resizing window, will </p>
          </div>
